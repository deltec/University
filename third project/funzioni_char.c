...
char *ConcStr(char* Str1,char* Str2)
{
   ...
   Str3=(char*)malloc( (Len1+Len2+2) * sizeof(char) );/*alloco spazio della stringa1 stringa2 e 2 caratteri in piu uno per il carattere di terminazione e uno per lo spazio*/
   strcpy(Str3,Str1);
   Str3[Len1]=' ';
